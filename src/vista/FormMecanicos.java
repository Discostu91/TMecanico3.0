 ...
 * @author Alvaro
 */
public class FormMecanicos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestión de Mantenciones");
...
RegistrarMarca marca=new RegistrarMarca();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMecanicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormMecanicos().setVisible(true);
            }
        });
    }
